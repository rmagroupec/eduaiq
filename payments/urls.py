...
urlpatterns = [
    ...
    path('api/payment/create-order/', views.create_razorpay_order_api, name='create_razorpay_order'),
    path('api/payment/verify-signature/', views.verify_razorpay_signature_api, name='verify_razorpay_signature'),
]
