...
from .models import CourseCategory, Course, CourseModule, Lesson, Quiz, QuizQuestion, Enrollment, QuizAttempt, AssignmentSubmission
...
class QuizAttemptAdmin(admin.ModelAdmin):
    list_display = ('student', 'quiz', 'score_pct', 'status', 'started_at', 'submitted_at')
