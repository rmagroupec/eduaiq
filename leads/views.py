...
def lead_convert(request, pk):
    ...
    institution = Institution(
        ...
        city=body.get('city') or lead.city or 'City pending',
        state=body.get('state') or lead.state or 'State pending',
...
def opportunity_list(request):
    ...
    if not body.get('owner'):
        ...
        if lead_id:
            ...
            if inquiry_obj and inquiry_obj.owner:
                body['owner'] = inquiry_obj.owner.pk
