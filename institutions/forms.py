...
class StudentForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = [
            'user', 'institution', 'batch',
            'admission_no', 'roll_number', 'class_grade', 'section', 'academic_year', 'admission_date',
            'date_of_birth', 'gender', 'blood_group', 'category',
            'father_name', 'mother_name', 'guardian_name', 'guardian_relation',
            'guardian_phone', 'guardian_email', 'parent_users', 'aadhar_or_id_proof',
